    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show: true }" @click.away="show = false">
                ...
                <div x-show="show" class="py-2 bg-gray-100 w-full mt-2 rounded-xl absolute z-50" style="display: none">

                {{-- Default value --}}
                <a href="/" class="block text-left px-3 text-small leading-6 hover:bg-blue-500 hover:text-white focus:text-white focus:bg-blue-500">All</a>
